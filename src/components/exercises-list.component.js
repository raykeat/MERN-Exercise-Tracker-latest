...
function ExercisesList() {
    ...
    useEffect(() => {
        ...
        axios.get('https://mern-exercise-tracker-backend.onrender.com/exercises/')
            .then(response => {
    ...
    function DeletePost(exercise_id){
        axios.delete(`https://mern-exercise-tracker-backend.onrender.com/exercises/${exercise_id}`)
            .then(response => {
